...
SNTPClientSocket.sendto(paquete.to_data(), serverAddressPort) 
# envia al servidor el paquete

#msgFromServer = UDPClientSocket.recvfrom(bufferSize) # recibe el aviso del servidor
#msg = format(msgFromServer[0].decode()) # decodifica el mensaje 
